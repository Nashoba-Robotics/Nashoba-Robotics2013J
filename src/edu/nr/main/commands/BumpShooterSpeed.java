 ...
 *
 */
public class  BumpShooterSpeed extends Command 
{
    private boolean posotively;
    //Empty private constructor so classes cannot create this class without specifying a speed
    public BumpShooterSpeed(boolean posotively) 
    {
        super("ShooterRunCommand");
        this.posotively = posotively;
    ...
    {
        RobotMain.shooter.bumpSpeed(posotively);
    }
