...
public class RobotMain extends IterativeRobot {
 ...
 used for any initialization code.
	...
	RobotMap.init();
        ...
        accelerometer = new ADXL345_I2C(2, ADXL345_I2C.DataFormat_Range.k2G);
	...
	{
            SmartDashboard.putNumber("I2C Accelerometer Y Axis", accelerometer.getAcceleration(ADXL345_I2C.Axes.kY));
            SmartDashboard.putNumber("Arduino getForce()", arduino.getForce());
